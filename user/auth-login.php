...
if(isset($_POST['login_user'])){
    ...
    if(mysqli_num_rows($resultusername) == 0){
        $error_status = "Login is failed";
    }else{
        $rowusername = mysqli_fetch_assoc($resultusername);
        $dbpass = $rowusername['password_member'];
        $dbusername = $rowusername['username_member'];
        if(!password_verify($password, $dbpass)){
            $error_status = "Login is failed";
        }else{
            $_SESSION['login_user_fina'] = true;
                ...
                <div class="row justify-content-center">
                    ...
                    <?php if($error_status != ""){ ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="d-grid mt-4">
                                                    <button class="btn btn-primary waves-effect waves-light" type="submit" name="login_user">Log In</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="mt-5 text-center">
                            <p class="text-white-50">Don't have an account ? <a href="auth-register" class="fw-medium text-primary"> Register </a> </p>
