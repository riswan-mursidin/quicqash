                  ...
                  <div class="card-body">
                    <div class="col-12">
                      <p>
                        ...
                        <span class="text-success">
                          <?php  
                          $queryPinAktif = "SELECT * FROM pin_activation_fina WHERE status_pin = 'Active' AND pemilik_pin='$username'";
                      ...
                      <p>
                        ...
                        <span class="text-danger">
                          <?php  
                          $queryPinNonAktif = "SELECT * FROM pin_activation_fina WHERE status_pin = 'Non Active' AND pemilik_pin='$username'";
                    ...
                    <table id="datatable" class="table table-hover table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" >
                      ...
                      <tbody>
                        <?php  
                        $num = 0;
                        $queryPin = "SELECT * FROM pin_activation_fina WHERE  pemilik_pin='$username' ORDER BY tgl_pin DESC";
