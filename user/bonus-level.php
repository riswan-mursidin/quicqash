            ...
            <div class="row">
              <div class="col-12">
                <div
                  ...
                  "
                >
                  <h4 class="mb-sm-0">Bonus Generasi FNC</h4>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php  
                    $querybonus = "SELECT level_sponsor FROM bonus_sponsor_fina";
                    $resultbonus = mysqli_query($conn, $querybonus);
                    while($rowbonus=mysqli_fetch_assoc($resultbonus)){
                    ?>
                      <li class="nav-item waves-effect waves-light">
                          <a class="nav-link  <?= $rowbonus['level_sponsor'] == 1 ? 'active' : '' ?>" data-bs-toggle="tab" href="#level<?= $rowbonus['level_sponsor'] ?>" role="tab">
                              <span class="d-none d-md-inline-block">Level </span> <?= $rowbonus['level_sponsor'] ?>
                          </a>
                      </li>
                      <?php } ?>
                    </ul>
                    ...
                    $resultbonus = mysqli_query($conn, $querybonus);
                    while($rowbonus=mysqli_fetch_assoc($resultbonus)){
                      $lvl = $rowbonus['level_sponsor'];
                    ?>
                      <div class="tab-pane <?= $rowbonus['level_sponsor'] == 1 ? 'active' : '' ?>" id="level<?= $rowbonus['level_sponsor'] ?>" role="tabpanel"> 
                        <h6 class="mb-3"><b>Level <?= $rowbonus['level_sponsor'] ?></b></h6>
