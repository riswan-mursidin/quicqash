            ...
            <div class="row">
              <div class="col-12">
                <div
                  ...
                  "
                >
                  <h4 class="mb-sm-0">Log PIN <?= strtoupper($username) ?></h4>
                  ...
                  <div class="card-body">
                    <table id="datatable" class="table table-hover table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" >
                      ...
                      <tbody>
                        <?php  
                        $num = 0;
                        $queryStory = "SELECT * FROM history_transaksi_pin_fina WHERE penerima_pin = '$username' ORDER BY tgl_transaksi_pin DESC";
                        $resultPin = mysqli_query($conn, $queryStory);
                        while($rowPin = mysqli_fetch_assoc($resultPin)){
                        ?>
                        <tr>
                          <td><?= ++$num ?></td>
                          <td><?= $rowPin['tgl_transaksi_pin'] ?></td>
                          <td>Receive <?= $rowPin['jumlah_pin'] ?> PIN from : ADMIN	</td>
                          <td><?= $rowPin['jumlah_pin'] ?> FNC</td>
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
